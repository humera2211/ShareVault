...
const FilePreview = ({file , removeFile}) => {
  return (
    <div className='flex justify-between items-center border-2 p-2 rounded-lg bg-slate-100 mt-3 '>
    <FileText width={50} height={50} className='text-blue-600 bg-zinc-300 rounded-lg p-1'/>
    <div>
    <h1>{file.name}</h1>
